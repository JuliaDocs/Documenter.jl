...

{
    ...
    "category": "function",
    "text": "git_push(\n    root, tmp, repo;\n    branch=\"gh-pages\", dirname=\"\", target=\"site\", tag=\"\", key=\"\", sha=\"\", devurl=\"dev\"\n)\n\nHandles pushing changes to the remote documentation branch. When tag is empty the docs are deployed to the devurl directory, and when building docs for a tag they are deployed to a vX.Y.Z directory, and also to the stable directory.\n\n\n\n\n\n"
},
