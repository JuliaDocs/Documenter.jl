...
@testset "DocSystem" begin
    ...
    foo_4 = Documenter.DocSystem.getdocs(
        Docs.Binding(TestDocstrings, :foo),
        Tuple{AbstractFloat}
    )
    ...
    @test Documenter.DocSystem.getdocs(
        Docs.Binding(TestDocstrings, :foo),
        Tuple{Float64},
        compare=(<:)
    ) == foo_1
    ...
    @test Documenter.DocSystem.getdocs(Docs.Binding(TestDocstrings, :bar), Tuple{Int}) ==
          foo_2
    @test Documenter.DocSystem.getdocs(
        Docs.Binding(TestDocstrings, :bar),
        Tuple{Float64}
    ) == foo_3
    @test Documenter.DocSystem.getdocs(
        Docs.Binding(TestDocstrings, :bar),
    ...
    @test Documenter.DocSystem.getdocs(Docs.Binding(TestDocstrings, :bar), Tuple{Number}) ==
          foo_5
    @test Documenter.DocSystem.getdocs(Docs.Binding(TestDocstrings, :bar), Tuple{Any}) ==
          foo_6
    # unless we disable following aliases
    @test Documenter.DocSystem.getdocs(Docs.Binding(TestDocstrings, :bar); aliases=false) |>
          isempty
    @test Documenter.DocSystem.getdocs(
        Docs.Binding(TestDocstrings, :bar),
        Tuple{Int};
    ...
    baz_4 = Documenter.DocSystem.getdocs(
        Docs.Binding(TestDocstrings, :baz),
        Tuple{AbstractFloat}
    )
    ...
    @test Documenter.DocSystem.getdocs(Docs.Binding(TestDocstrings, :baz); aliases=false) ==
          baz_1
    @test Documenter.DocSystem.getdocs(
        Docs.Binding(TestDocstrings, :baz),
        Tuple{Int};
