...
@testset "doc checks" begin
    ...
    @testset "allbindings" begin
        ...
        @test Docs.Binding(TestModule, :dep1_private_2) ==
              Docs.Binding(Dep1, :dep1_private_2)
        @test Docs.Binding(TestModule, :dep1_exported) == Docs.Binding(Dep1, :dep1_exported)
        @test Docs.Binding(TestModule, :dep1_reexported) ==
              Docs.Binding(Dep1, :dep1_reexported)
