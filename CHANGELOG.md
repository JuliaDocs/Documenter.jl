...
* ![Enhancement][badge-enhancement] Search engine and social media link previews are now supported by generating the relevant HTML `meta` tags. ([#1321][github-1321], [#1991][github-1991])
