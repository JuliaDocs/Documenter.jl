...
* ![Enhancement][badge-enhancement] Added keyboard shortcuts for search box (`ctrl + /` or `cmd + /` to focus into the search box, `Esc` to focus out of it). ([#1536][github-1536], [#2027][github-2027])
