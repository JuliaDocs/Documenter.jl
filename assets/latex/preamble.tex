...
% Part num to part title spacing
\setlength{\cftpartnumwidth}{2.0em \@plus \p@}
% Chapter num to chapter title spacing (Figure 9.2@memman)
\setlength{\cftchapternumwidth}{3.0em \@plus \p@}
% indent before section number
\setlength{\cftsectionindent}{3.0em \@plus \p@}
% Section num to section title spacing (Figure 9.2@memman)
\setlength{\cftsectionnumwidth}{3.5em \@plus \p@}
\makeatother
